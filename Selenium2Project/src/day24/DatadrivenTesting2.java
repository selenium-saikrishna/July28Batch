...
public class DatadrivenTesting2  extends BaseClass{
	...
	{
		FileInputStream file=new FileInputStream(".\\src\\com\\projectname\\excelfiles\\registration.xlsx");
		...
		FileOutputStream f=new FileOutputStream(".\\src\\com\\projectname\\resultexcelfiles\\registration.xlsx");
		wb.write(f);
		wb.close();
